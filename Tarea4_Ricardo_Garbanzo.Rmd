---
title: "Tarea 4"
subtitle: "Análisis de agresores"
author: "Ricardo Garbanzo"
institute: "Generación Descartes"
date: "`r Sys.Date()`"
output:
...
ggplot(datos, aes(x=datos$rango_edad, y=datos$cantidad, fill=datos$sexo)) +
  ...
  labs(title = "Ejercicio 1-C - Agresores", x = "Rando de edad", y = "Cantidad de casos") +
  theme_classic() +
...
---
# Análisis con apexcharter
```{r Ejercicio 1 - D, echo=FALSE}
library(apexcharter)
